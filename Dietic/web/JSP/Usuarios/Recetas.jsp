        ...
        <main class="page-content">
            <div class="container-fluid">
                ...
                <section>
                    <div class="row">
                        <div class="col">
                            <h1 class="h1"><i class="fas fa-apple-alt"></i><strong>Mis Recetas</strong>
                            </h1>
                ...
                <section>
                    <div class="row">
                        <div class="col">
                            <table id="table_recetas_usuario" class="table table-striped table-hover table-responsive-sm">
